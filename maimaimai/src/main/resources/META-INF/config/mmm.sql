...
insert into sys_user_role (sys_id, user_sys_id, granted_role) values ('20150516200052730291603678411763','20150516200052729130777478939644','admin');
insert into sys_user_role (sys_id, user_sys_id, granted_role) values ('20150516200052731236298868990543','20150516200052729130777478939644','user');
insert into sys_user_role (sys_id, user_sys_id, granted_role) values ('20150516200052731423393540520357','20150516200052729130777478939644','maint');
insert into sys_user_role (sys_id, user_sys_id, granted_role) values ('20150516200052732189416786015391','20150516200052729664702011635382','user');
insert into sys_user_role (sys_id, user_sys_id, granted_role) values ('20150516200052732522083217021902','20150516200052729773953853136354','guest');
